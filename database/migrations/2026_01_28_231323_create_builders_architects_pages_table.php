...
return new class extends Migration {
    ...
    {
        Schema::create('builders_architects_pages', function (Blueprint $table) {
            $table->id();
            ...
            // ---------------- 3 COLUMNAS (cada una: titulo + texto + bullets) ----------------
            // Col 1
            ...
            $table->text('col1_bullets_es')->nullable(); // texto con saltos de línea o HTML
            ...
            // ---------------- IMAGEN BANNER (la de background) ----------------
            ...
            // ---------------- BLOQUE FINAL + PRODUCTOS SELECCIONADOS ----------------
            ...
            // IDs de productos en ORDEN (para los íconos/listado final)
    ...
    {
        Schema::dropIfExists('builders_architects_pages');
    }
};
